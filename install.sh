...
if [ -d "${SCRIPT_DIR}/bundle/KeyTap.iconset" ]; then
    iconutil -c icns "${SCRIPT_DIR}/bundle/KeyTap.iconset" -o "${APP_DIR}/Contents/Resources/AppIcon.icns"
...
echo "==> Starting keytap"
launchctl bootstrap "gui/$(id -u)" "${PLIST_DST}"

echo ""
echo "Done! KeyTap is running."
echo ""
...
echo "  Logs:    tail -f /tmp/keytap.err"
